                    ...
                    <div class="col">
                        <ul class="navbar-nav">
                            ...
                            @can('قائمة المستخدمين')
                                ...
                                <li class="nav-item dropdown {{ request()->routeIs('admin.manger.*') ? 'active' : '' }}">
                            ...
                            @can('قائمة قاعدة البيانات')
                                
                            <li
                                class="nav-item {{ request()->routeIs('admin.settings.create.database') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.settings.create.database') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg"
